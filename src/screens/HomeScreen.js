...
export default function HomeScreen() {
  ...
  return (
    ...
    <LinearGradient
      colors={["#E8EDEB", "#CDE0F5", "#E8EDEB"]} // As cores do degradê
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 1 }}
      style={styles.container}
    >
      {/* SafeAreaView agora fica aqui dentro para proteger o conteúdo do notch */}
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <FlatList
                data={exames}
                keyExtractor={(item) => item.id.toString()} // Adicionado .toString() por segurança
                renderItem={({ item }) => (
                  <TouchableOpacity
